...
GRID = [
    {"VAD_ENDPOINTING_SILENCE_MS": "300", "ENDPOINTING_DELAY_MS": "300", "BARGEIN_ACTIVATION_THRESHOLD": "0.7", "BARGEIN_MIN_SPEECH_MS": "120", "NOISE_GATE_ENABLED": "1"},
    {"VAD_ENDPOINTING_SILENCE_MS": "400", "ENDPOINTING_DELAY_MS": "400", "BARGEIN_ACTIVATION_THRESHOLD": "0.7", "BARGEIN_MIN_SPEECH_MS": "120", "NOISE_GATE_ENABLED": "1"},
    {"VAD_ENDPOINTING_SILENCE_MS": "500", "ENDPOINTING_DELAY_MS": "300", "BARGEIN_ACTIVATION_THRESHOLD": "0.7", "BARGEIN_MIN_SPEECH_MS": "120", "NOISE_GATE_ENABLED": "1"},
    {"VAD_ENDPOINTING_SILENCE_MS": "600", "ENDPOINTING_DELAY_MS": "600", "BARGEIN_ACTIVATION_THRESHOLD": "0.7", "BARGEIN_MIN_SPEECH_MS": "120", "NOISE_GATE_ENABLED": "1"},
    {"VAD_ENDPOINTING_SILENCE_MS": "400", "ENDPOINTING_DELAY_MS": "400", "BARGEIN_ACTIVATION_THRESHOLD": "0.7", "BARGEIN_MIN_SPEECH_MS": "120", "NOISE_GATE_ENABLED": "0"},
]
...
def main():
    ...
    for gi, config in enumerate(GRID):
        vad_s = config.get('VAD_ENDPOINTING_SILENCE_MS', config.get('ENDPOINTING_MIN_SILENCE_MS', '?'))
        ep_d = config.get('ENDPOINTING_DELAY_MS', '?')
        th = config.get('BARGEIN_ACTIVATION_THRESHOLD', '?')
        sp = config.get('BARGEIN_MIN_SPEECH_MS', '?')
        ng = config.get('NOISE_GATE_ENABLED', '?')
        label = f"vs{vad_s}_ed{ep_d}_th{th}_sp{sp}_ng{ng}"
