...
TTS_DEEP_STREAM_PACKET_TOKENS=${TTS_DEEP_STREAM_PACKET_TOKENS:-4}
TTS_DEEP_STREAM_LEFT_CONTEXT=${TTS_DEEP_STREAM_LEFT_CONTEXT:-25}
TTS_DEEP_STREAM_DETERMINISTIC=${TTS_DEEP_STREAM_DETERMINISTIC:-1}

export TTS_MODEL_DIR TTS_STAGE_CONFIG TTS_HOST TTS_PORT
export TTS_DEEP_STREAM_ENABLE TTS_DEEP_STREAM_PACKET_TOKENS TTS_DEEP_STREAM_LEFT_CONTEXT
export TTS_DEEP_STREAM_DETERMINISTIC
